...
export function PhotoTile({
  ...
  return (
    <figure
      className={cn(
        "group relative overflow-hidden rounded-md border border-bronze/40 bg-noir",
    ...
    >
      ...
      {/* Name plate */}
      <figcaption className="absolute inset-x-0 bottom-0 translate-y-1 bg-gradient-to-t from-black/90 via-black/60 to-transparent px-3 pb-2.5 pt-8">
